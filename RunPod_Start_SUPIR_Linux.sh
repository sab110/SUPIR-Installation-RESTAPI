...
# ----------------------------------------
# 1. Enter the SUPIR directory and activate venv
# ----------------------------------------
cd SUPIR
source ./venv/bin/activate

# ----------------------------------------
# 2. Suppress Python warnings (optional)
# ----------------------------------------
export PYTHONWARNINGS="ignore"

# ----------------------------------------
# 3. (Optional) Pin a specific CUDA device
# ----------------------------------------
# If you need to force a particular GPU, uncomment and set:
# export CUDA_VISIBLE_DEVICES=0

# ----------------------------------------
# 4. Display VRAM usage hints (informational)
# ----------------------------------------
echo "----------------------------------------"
echo "SUPIR API server startup:"
echo "– Uses VRAM optimizations under the hood."
echo "– BF16/FP16 mode will consume roughly 12 GB of GPU VRAM."
echo "– FP8 mode will consume roughly 8 GB of GPU VRAM."
echo "– If you have >30 GB VRAM, a full-precision run is also possible."
echo "----------------------------------------"
echo
...
# ----------------------------------------
# Adjust host/port as needed for RunPod deployment.
# By default, we bind to 0.0.0.0:8000.
uvicorn api_server:app --host 0.0.0.0 --port 8000

# ----------------------------------------
# 6. (Cleanup after shutdown, if desired)
# ----------------------------------------
# deactivate
# echo "SUPIR API server has stopped."
